...
if (isset($_POST['agregar_prov'])) {
    ...
    $sql_insert = "INSERT INTO Proveedor (Id_Proveedor, dia_surtido, hora_surtido) VALUES ('$id', '$dia', '$hora')";
...
if (isset($_POST['agregar_tel'])) {
    ...
    $tel = $_POST['telefono'];
    $sql_insert = "INSERT INTO Telefono_Proveedor (Id_Proveedor, telefono) VALUES ('$id', '$tel')";
    $conn->query($sql_insert);
    header("Location: proveedor.php");
    exit;
}
...
<body class="admin-page">
    ...
    <main>
        ...
        <form action="proveedor.php" method="POST">
            <input type="text" name="id_proveedor" placeholder="ID Proveedor" required>
